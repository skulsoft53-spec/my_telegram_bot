...
# ========== ТРИГГЕРЫ (с «сын шлюхи» и другими) ==========
trigger_words = [
    # Сын шлюхи и подобные
    "сын шлюхи", "сын бляди", "сын проститутки", "сукин сын", "сучьи сыны",
    "дочь шлюхи", "дочь бляди", "сукина дочь", "блядин сын", "шлюхин сын",
    "шлюхина дочь", "блядина дочь", "сукин кот", "сукины дети",
    # Оскорбления матери
    "твоя мать", "твоя мама", "твоя мамаша", "мать твою", "маму твою",
    "твою мать", "твою маму", "мамаша твоя", "мать шалава", "мама шлюха",
    "мать блядина", "твоя мать шлюха", "твоя мать блядь",
    # Оскорбления отца
    "твой отец", "твой папа", "твой батя", "папаша твой", "отец козел",
    "твой отец петух", "папа твой мудак", "батя твой дебил",
    # Оскорбления родителей
    "родители твои", "твои родители", "предки твои", "твои предки",
    "родаки твои", "твои родаки",
    # Обычные матерные
    "сука", "бля", "блядь", "блять", "шлюха", "проститутка", "курва",
    "хуй", "хуйня", "хуесос", "хуила", "похуй", "нахуй", "охуел", "ахуел",
    "пизда", "пиздец", "пиздюк", "пиздабол", "ебал", "ебать", "ебаный", 
    "ебанутый", "заебал", "выебал", "доебал", "приебал", "уебан",
    # Оскорбления
    "уебок", "мудила", "мудак", "мудило", "пидор", "петух", "педик", "гомик",
    "даун", "дебил", "дебилоид", "идиот", "идиотия", "лох", "лошара", "дурак",
    "дурачина", "тупой", "тупица", "тупорылый", "безмозглый", "бездарь",
    "тварь", "скотина", "сволочь", "падла", "гнида", "мразь", "мразина",
    "урод", "выродок", "чмо", "чмобила", "редиска", "козел", "овца", "баран",
    "олень", "петушара", "пидорас", "гомосек", "гей", "педераст",
    # Комбинации
    "ебаный в рот", "ебаный в жопу", "пошёл нахуй", "иди нахуй", "нахуй иди",
    "в пизду", "в жопу", "в рот", "еб твою мать", "ёб твою мать",
    "твою мать", "ёбаный", "бля буду", "сука блядь",
]
...
auto_replies_without_mention = [
    ...
    "соси хуй",
    "ты кто вообще такой?",
    "твоё мнение нихуя не важно",
    "ты даже не человек",
    "ты пустота",
    "ты ошибка природы",
    "твоя жизнь — ошибка",
    "тебя даже черви брезгуют",
    "ты никто",
    "ты ничто",
    "ты просто сукин сын",
]
...
async def start(update: Update, context):
    await update.message.reply_text(
        ...
        "🤖 Бот сам отвечает на мат и оскорбления",
        parse_mode='Markdown'
    )
