...
# ====== Настройки ======
TELEGRAM_TOKEN = "8456574639:AAF67RT8myD5CNe8RmiHh9DrbT-ZkwvstDc"  # твой токен
OWNER_USERNAME = "bxuwy"  # твой телеграм-ник для команды /restart
...
# ====== Последнее сообщение для пользователей ======
last_messages = {}
...
async def restart_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    os._exit(0)  # Render автоматически перезапустит бота
