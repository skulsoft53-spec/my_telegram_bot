...
LOVE_PHRASES = [
    ...
    "Ты — свет в моём мире 🌟",
    "Ты — солнечный луч в пасмурный день ☀️",
    "Ты — мелодия моего сердца 🎶",
    "Ты — магия, что делает всё прекрасным ✨",
    "Ты — моя любовь и моя мечта 💞",
    "Ты — утро, что хочется встречать каждый день 🌅",
    "Ты — тепло, что согревает душу 🔥",
    "Ты — гармония в хаосе мира 🌺",
    "Ты — моё счастье, что всегда рядом 💗",
    "Ты — мой свет и моя нежность 🌷",
]
...
HARD_NEGATIVE_WORDS = [
    ...
    "Ты — постоянная помеха для всех целей!",
    "Ты — источник неудач и разочарований!",
    "Твои решения только усугубляют проблемы!",
    "Ты — воплощение эгоизма и безразличия!",
    "Ты — причина всех ссор и конфликтов!",
    "Ты портите всё вокруг своим поведением!",
    "Ты — настоящий магнит для неприятностей!",
    "Твоя глупость поражает всех знакомых!",
    "Ты — бесконечный источник раздражения!",
    "Невозможно работать с твоей безответственностью!",
    "Ты — разрушитель радости других людей!",
    "Твои слова лишены смысла и мудрости!",
    "Ты — источник нервного напряжения для всех!",
    "Ты всегда создаёшь проблемы на пустом месте!",
    "Твои действия вызывают только негативные эмоции!",
    "Ты — угроза гармонии и спокойствию!",
    "Ты портите даже самые приятные моменты!",
    "Твои слова ранят и оскорбляют окружающих!",
    "Ты — причина стресса и недовольства!",
    "Ты постоянно мешаешь нормальной жизни другим!",
    "Ты — воплощение негативной энергии!",
    "Твоя самовлюблённость невыносима!",
    "Ты превращаешь счастье других в грусть!",
    "Твои действия лишают людей спокойствия!",
    "Ты — постоянная причина конфликтов!",
    "Твоя лень и равнодушие раздражают всех!",
    "Ты — разрушитель всего позитивного вокруг!",
    "Твои слова вызывают злость и обиду!",
    "Ты — источник постоянного напряжения!",
    "Ты портите атмосферу своей присутствием!",
    "Твоя токсичность невыносима для всех!",
    "Ты — воплощение хаоса и разочарования!",
    "Ты создаёшь стресс для всех знакомых!",
    "Ты постоянно разрушаешь гармонию!",
    "Ты — угроза нормальному общению!",
    "Твои действия всегда вызывают раздражение!",
    "Ты — причина дискомфорта для окружающих!",
    "Ты — магнит для неприятностей и проблем!",
]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Я буду отвечать на сообщения @Habib471 романтически, а @vkhich1ro — негативно 💌\n"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if username in TARGET_USERNAMES and random.random() < 0.4:
    ...
    # Негативные ответы
    elif username in NEGATIVE_USERNAMES and random.random() < 0.4:
...
def main():
    ...
    print("💞 LoveBot запущен и ждёт сообщений...")
    app.run_polling()
