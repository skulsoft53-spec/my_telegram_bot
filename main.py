...
# Пользователи
TARGET_USERNAMES = ["Habib471"]       # Романтические фразы
NEGATIVE_USERNAMES = ["vkhich1ro"]    # Негативные слова
...
LOVE_PHRASES = [
    ...
    "Ты — песня сердца без слов 🎵",
    "Ты — утренний свет моей души 🌞",
    "Ты — радость, которую невозможно описать 💖",
    "Ты — счастье в каждой мелочи 💕",
    "Ты — нежный ветер перемен 🌸",
    "Ты — моя вселенная в одном взгляде 🌌",
    "Ты — причина, чтобы верить в чудо ✨",
    "Ты — моё вдохновение на каждый день 💫",
    "Ты — гармония среди хаоса мира 🌺",
    "Ты — светлый луч в темноте 🌟",
    "Ты — мой идеальный момент здесь и сейчас 💗"
]

# 100 Жёстких негативных слов
HARD_NEGATIVE_WORDS = [
    "отвратительный лицемерный интриган без капли совести",
    "жалкое ничтожество, которое только умеет жаловаться",
    "трусливый подлец, прячущийся за чужими спинами",
    "ничтожный эгоист, сеющий раздор и злость",
    "хам и грубиян без намёка на доброту",
    "жалкий подонок, заслуживающий презрения",
    "лицемерный плут, обманывающий всех вокруг",
    "неуклюжий провокатор, разрушающий счастье других",
    "тупой и упрямый вредитель чужого мира",
    "мелочный предатель с грязными намерениями",
    "подлый лицемерный урод, уничтожающий радость",
    "отвратительное создание, не знающее доброты",
    "завистливый манипулятор чужими чувствами",
    "гнусный эгоист, приносящий только страдания",
    "жалкий предатель с мерзкой улыбкой",
    "подлец с грязными мыслями и скверным сердцем",
    "нечестный и злой подонок общества",
    "трусливый плут, гнусно скрывающий свои поступки",
    "мелочный лицемерный эгоист",
    # … добавьте до 100 для полного списка
]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "💞 Привет! Я LoveBot.\n"
        "Отвечаю @Habib471 романтическими фразами, а @vkhich1ro — жёсткими словами 💌\n"
